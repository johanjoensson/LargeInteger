...
// configuration step. It creates a namespace called `LargeInteger`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", LargeInteger::cmake::project_name, LargeInteger::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", LargeInteger::cmake::project_version);
      return EXIT_SUCCESS;
    }
